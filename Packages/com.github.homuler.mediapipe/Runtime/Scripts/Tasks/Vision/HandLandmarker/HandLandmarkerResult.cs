...
namespace Mediapipe.Tasks.Vision.HandLandmarker
{
    ...
    public readonly struct HandLandmarkerResult
    {
        ...
        internal HandLandmarkerResult(
            List<Classifications> handedness,
            List<NormalizedLandmarks> handLandmarks,
            List<Landmarks> handWorldLandmarks
        )
        {
        ...
        public void CloneTo(ref HandLandmarkerResult destination)
        {
            ...
            destination = new HandLandmarkerResult(
                dstHandedness,
                dstHandLandmarks,
                dstHandWorldLandmarks
            );
        }
