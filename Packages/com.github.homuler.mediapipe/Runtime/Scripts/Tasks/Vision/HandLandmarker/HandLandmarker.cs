...
#pragma warning restore IDE0052
        ...
        /// </returns>
        public static HandLandmarker CreateFromModelPath(
            string modelPath,
        ...
        private PacketMap DetectInternal(
            Image image,
            Core.ImageProcessingOptions? imageProcessingOptions
        )
        {
        ...
        {
            using var outputPackets = DetectForVideoInternal(
                image,
                timestampMillisec,
                imageProcessingOptions
            );
        ...
        private PacketMap DetectForVideoInternal(
            Image image,
            long timestampMillisec,
            Core.ImageProcessingOptions? imageProcessingOptions = null
        )
        ...
        private static bool TryBuildHandLandmarkerResult(
