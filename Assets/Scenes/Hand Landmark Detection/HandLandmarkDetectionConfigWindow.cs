...
namespace Mediapipe.Unity.Sample.HandLandmarkDetection.UI
{
    ...
    {
        [SerializeField]
        private Dropdown _delegateInput;

        [SerializeField]
        private Dropdown _imageReadModeInput;

        [SerializeField]
        private Dropdown _runningModeInput;

        [SerializeField]
        private InputField _numHandsInput;

        [SerializeField]
        private InputField _minHandDetectionConfidenceInput;

        [SerializeField]
        private InputField _minHandPresenceConfidenceInput;
        ...
        {
            InitializeDropdown<Tasks.Core.BaseOptions.Delegate>(
                _delegateInput,
                _config.Delegate.ToString()
            );
            _delegateInput.onValueChanged.AddListener(
                delegate
                {
                    SwitchDelegate();
                }
        ...
        {
            InitializeDropdown<ImageReadMode>(
                _imageReadModeInput,
                _config.ImageReadMode.GetDescription()
            );
            _imageReadModeInput.onValueChanged.AddListener(
                delegate
                {
                    SwitchImageReadMode();
                }
        ...
        {
            InitializeDropdown<Tasks.Vision.Core.RunningMode>(
                _runningModeInput,
                _config.RunningMode.ToString()
            );
            _runningModeInput.onValueChanged.AddListener(
                delegate
                {
                    SwitchRunningMode();
                }
        ...
        private void InitializeNumHands()
        {
            ...
            _numHandsInput.onValueChanged.AddListener(
                delegate
                {
                    SetNumHands();
                }
        ...
        private void InitializeMinHandDetectionConfidence()
        {
            ...
            _minHandDetectionConfidenceInput.onValueChanged.AddListener(
                delegate
                {
        ...
        private void InitializeMinHandPresenceConfidence()
        {
            ...
            _minHandPresenceConfidenceInput.onValueChanged.AddListener(
                delegate
                {
        ...
        private void InitializeMinTrackingConfidence()
        {
            ...
            _minTrackingConfidenceInput.onValueChanged.AddListener(
                delegate
                {
